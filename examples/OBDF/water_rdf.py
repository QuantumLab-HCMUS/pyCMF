...
# from pyscf.mp import UOBMP2_faster, UOBMP2_downfold, OBMP2_faster, obmp2_faster, OBMP2_downfold
...
# Tạo phân tử H2O
mol = gto.Mole()
mol.atom = [['O', (0.0, 0.0, -0.06990256)], ['H', (0.0, 0.75753241, 0.51843495)], ['H', (0.0, -0.75753241, 0.51843495)]]
